 ...
 * 28-Oct-2002 : Created alu0101361093.main title and subtitle list to replace existing title
 *               list (DG);
 ...
 * 29-Jun-2009 : Check visibility flag in alu0101361093.main title (DG);
...
public class JFreeChart implements Drawable, TitleChangeListener,
    ...
    /**
     * Returns the alu0101361093.main chart title.  Very often a chart will have just one
     * title, so we make this case simple by providing accessor methods for
     * the alu0101361093.main title.  However, multiple titles are supported - see the
    ...
    /**
     * Sets the alu0101361093.main title for the chart and sends a {@link ChartChangeEvent}
