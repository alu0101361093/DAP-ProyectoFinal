    ...
    public Dataset createDataset(Object data1, Object data2, Object data3, Object data4, String name1, String name2, String name3, String name4) {
        ...
        if (!name1.isEmpty() || !(name1 == "#") || !(name1 == "@")) {
            for (Object o : (JSONArray) ( (JSONObject) data1).get("data") ) {
                ...
                String recordDayMonthYear = recordDate.getDayOfMonth() + "-" + recordDate.getMonthOfYear() + "-" + recordDate.getYear();
                dataset.addValue( (int) jsonObject.get("tweet_count"), name1, new Day(recordDate.getDayOfMonth(), recordDate.getMonthOfYear(), recordDate.getYear()));
            }
        }
        if (!name2.isEmpty() || !(name2 == "#") || !(name2 == "@")) {
            for (Object o : (JSONArray) ( (JSONObject) data2).get("data") ) {
                ...
                LocalDate recordDate = formatter.parseLocalDate((String) jsonObject.get("start"));
                String recordDayMonthYear = recordDate.getDayOfMonth() + "-" + recordDate.getMonthOfYear() + "-" + recordDate.getYear();
                dataset.addValue( (int) jsonObject.get("tweet_count"), name2, new Day(recordDate.getDayOfMonth(), recordDate.getMonthOfYear(), recordDate.getYear()));
            }
        }
        if (!name3.isEmpty() || !(name3 == "#") || !(name3 == "@")) {
            for (Object o : (JSONArray) ( (JSONObject) data3).get("data") ) {
                ...
                LocalDate recordDate = formatter.parseLocalDate((String) jsonObject.get("start"));
                String recordDayMonthYear = recordDate.getDayOfMonth() + "-" + recordDate.getMonthOfYear() + "-" + recordDate.getYear();
                dataset.addValue( (int) jsonObject.get("tweet_count"), name3, new Day(recordDate.getDayOfMonth(), recordDate.getMonthOfYear(), recordDate.getYear()));
            }
        }
        if (!name4.isEmpty() || !(name4 == "#") || !(name4 == "@")) {
            for (Object o : (JSONArray) ( (JSONObject) data4).get("data") ) {
                ...
                LocalDate recordDate = formatter.parseLocalDate((String) jsonObject.get("start"));
                String recordDayMonthYear = recordDate.getDayOfMonth() + "-" + recordDate.getMonthOfYear() + "-" + recordDate.getYear();
                dataset.addValue( (int) jsonObject.get("tweet_count"), name4, new Day(recordDate.getDayOfMonth(), recordDate.getMonthOfYear(), recordDate.getYear()));
            }
        }
